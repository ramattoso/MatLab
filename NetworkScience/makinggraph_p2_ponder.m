...
cinza(1,3) = 70/255;
vermelho(1,1) = 1;
vermelho(1,2) = 105/255;
vermelho(1,3) = 97/255;
%% final plot
%degree = degree +1; % desenhar todos os nós
figure(2);
plot(G,'XData',xp,'YData',yp, 'NodeLabel',names,'MarkerSize', degree/8,'NodeFontSize', degree/30, 'LineWidth', 1.5*G.Edges.Weight, 'NodeColor', color, 'EdgeColor', coloredge, 'EdgeAlpha',0.35);
