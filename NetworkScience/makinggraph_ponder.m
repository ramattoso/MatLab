...
for i=1:nnodes
    degree(i) = sum(x(i,:)); %nnz(x(i,:)) -> in case of not pondered edges
end
% 1.1 mean degree 
...
figure(2); plot(G,'XData',xp,'YData',yp, 'NodeLabel', names, 'MarkerSize', 8, 'NodeFontSize', degree/10, 'LineWidth', G.Edges.Weight, 'NodeColor', color, 'EdgeColor', coloredge, 'EdgeAlpha',0.05);
%set(gca,'xtick',[]); set(gca,'ytick',[]); set(gca,'LooseInset',get(gca,'TightInset'));
cd ..
